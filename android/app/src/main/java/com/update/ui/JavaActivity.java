...
import com.rn_android.R;
import com.update.http.OkGoUpdateHttpUtil;
import com.update.http.UpdateAppHttpUtil;
import com.update.util.CProgressDialogUtils;
import com.update.util.HProgressDialogUtils;
...
//    private String mApkFileUrl = "https://raw.githubusercontent.com/WVector/AppUpdateDemo/master/apk/sample-debug.apk";
    private String mApkFileUrl = "http://download.sj.qq.com/upload/connAssitantDownload/upload/MobileAssistant_1.apk";
...
//        显示下载进度
    ...
    /**
     * 注释掉 HProgressDialogUtils 时候，进入后台下载可在状态栏中查看下载进度
     * 下载完成后可以弹出安装
     */
